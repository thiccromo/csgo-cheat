...
public:
	...
	void set_angles( Vector3 angles ) {
		using original_fn = void( __thiscall* )( void*, const Vector3& );
	...
	offset_fn( Vector3, origin, 0x134 );
	offset_fn( Vector3, view_offset, 0x104 );
...
public:
	...
	netvar_fn( Vector3, eye_angles, "DT_CSPlayer->m_angEyeAngles[0]" );
	...
	netvar_fn( Vector3, punch_angle, "DT_BasePlayer->m_viewPunchAngle" );
	netvar_fn( Vector3, aim_punch_angle, "DT_BasePlayer->m_aimPunchAngle" );
	netvar_fn( Vector3, velocity, "DT_BasePlayer->m_vecVelocity[0]" );
